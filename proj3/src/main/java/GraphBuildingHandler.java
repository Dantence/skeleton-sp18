...
public class GraphBuildingHandler extends DefaultHandler {
    ...
    private List<GraphDB.Node> readyNodes = new ArrayList<>();
...
//            System.out.println("Finishing a way...");
            if (lastWay.flag) {
                for (int i = 0; i < readyNodes.size() - 1; i++) {
                    g.addEdge(readyNodes.get(i), readyNodes.get(i + 1));
                }
            }
            readyNodes.clear();
        }
